  ...
  return (
    <>
      <div id="dep1" className="deparea" style={{ margin: "5px 0" }}>
        <Header as="h6" className="farsi">{Trans("chooseyourdeposit")}
        ...
        <Segment inverted className="blnc" size="mini" color="black">
          <Statistic inverted size="mini">
            ...
            <Statistic.Label className="farsi">{Trans("yourbalance")}</Statistic.Label>
          </Statistic>
        </Segment>
        <Divider inverted />
      ...
      >
        <Header as="h4" floated="left" className="farsi">
          {depMode.text}
        </Header>
        <div
          className="farsi"
        ...
        >
           {Trans("back")} <Icon name="arrow alternate circle left outline" />
        </div>
